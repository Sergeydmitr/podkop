...
REPO="https://api.github.com/repos/Sergeydmitr/podkop/releases/latest"
...
update_config() {
    ...
    printf "\033[48;5;196m\033[1m║ Подробности: https://github.com/Sergeydmitr/podkop                     ║\033[0m\n"
    ...
    printf "\033[48;5;196m\033[1m║ Details: https://github.com/Sergeydmitr/podkop                         ║\033[0m\n"
...
main() {
    ...
    if command -v curl >/dev/null 2>&1; then
        check_response=$(curl -s "https://api.github.com/repos/Sergeydmitr/podkop/releases/latest")
